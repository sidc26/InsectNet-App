# =========================================================
# 🧠 Base environment — lightweight Python 3.10 image
# =========================================================
...
# --- Common Python deps will be installed from requirements.txt in final stage ---

# =========================================================
# 🧩 CPU build stage (for local testing)
# =========================================================
FROM base AS cpu
...
# =========================================================
# ⚙️ GPU build stage (for Jetson Orin)
# =========================================================
FROM base AS arm64
...
# =========================================================
# 🚀 Final runtime image (default = GPU)
# =========================================================
FROM arm64 AS final
WORKDIR /app
